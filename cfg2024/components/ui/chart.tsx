...
const chartData = [
  { month: "January", curr: 186, prev: 80 },
  { month: "February", curr: 305, prev: 200 },
  { month: "March", curr: 237, prev: 120 },
  { month: "April", curr: 73, prev: 190 },
  { month: "May", curr: 209, prev: 130 },
  { month: "June", curr: 214, prev: 140 },
]
  ...
  return (
    <ChartContainer config={chartConfig} className="min-h-[200px] w-1/2">
      <BarChart accessibilityLayer data={chartData}>
        ...
        <Bar dataKey="curr" fill="var(--color-curr)" radius={4} />
  ...
  return (
    <Card className="flex flex-col w-1/2">
      <CardHeader className="items-center pb-0">
        <CardTitle>Website Turnover Rates</CardTitle>
      ...
      <CardContent className="flex-1 pb-0">
        ...
        >
          <PieChart>
            ...
            />
            <Pie data={chartDataPie} dataKey="visitors" nameKey="stage" />
          </PieChart>
        </ChartContainer>
      </CardContent>
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 font-medium leading-none">
          Offers are trending up by 5.2% this month <TrendingUp className="h-4 w-4" />
        </div>
