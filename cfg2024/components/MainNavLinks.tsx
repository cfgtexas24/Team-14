          ...
          <div className="flex space-x-2">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="text-[#344966] bg-white hover:bg-white text-2xl font-bold" style={{ boxShadow: 'none !important' }}>
                    Candidate
                ...
                <DropdownMenuContent align="start">
                  ...
                  <DropdownMenuItem>
                    <Link href="/bookings" className="text-[#344966] text-lg">Book Meetings</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
